    ...
    <div className="editor-textarea-container flex-1 min-h-0 relative flex bg-[var(--bg-editor)]">
      ...
      <div className="editor-input-area flex-1 relative min-h-0 overflow-hidden">
        ...
        <textarea
          ...
          onBlur={onBlur}
          className="editor-textarea absolute inset-0 w-full h-full bg-transparent border-none outline-none resize-none font-mono caret-[var(--accent-primary)] z-10 text-transparent selection:bg-[#ffa116]/30"
          spellCheck={false}
          autoCapitalize="none"
          autoComplete="off"
          autoCorrect="off"
